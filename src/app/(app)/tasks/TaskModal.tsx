    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {allMembers.length > 0 && (
        <div>
          ...
          {/* Search input + inline results (no portal — avoids Radix dialog click-outside interception) */}
          <input
            ref={searchRef}
            type="text"
          ...
          {assigneeSearch.trim() && (
            <div
              className="mt-1 rounded-md border border-[--color-border] overflow-hidden"
