...
const BG_MODES: { id: BgMode; label: string; desc: string }[] = [
  { id: "theme",  label: "Animated orbs",   desc: "Floating color orbs using your theme colors" },
        ...
        <div>
          ...
          {bgMode === "solid" && (
            <div className="flex items-center gap-3 p-3 rounded-lg border border-[--color-border] bg-[--color-surface-overlay]">
              <label className="text-sm text-[--color-text-secondary] shrink-0">Background color</label>
              <input
                type="color"
                value={bgSolidColor}
          ...
          {/* Custom orb color pickers */}
          {bgMode === "custom" && (
            <div className="flex flex-wrap gap-3 p-3 rounded-lg border border-[--color-border] bg-[--color-surface-overlay]">
