...
export function NewBaseItemForm() {
  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <div className="card space-y-4">
        <h2 className="text-h3 text-[--color-text-primary]">Stock & reorder</h2>
      ...
      <div className="card space-y-3">
        <h2 className="text-h3 text-[--color-text-primary]">FIRST</h2>
        <label className="flex items-center gap-2"><input type="checkbox" name="isKopItem" className="rounded" /><span className="text-sm text-[--color-text-primary]">Kit of Parts (KOP) item</span></label>
        <label className="flex items-center gap-2"><input type="checkbox" name="isFirstChoiceItem" className="rounded" /><span className="text-sm text-[--color-text-primary]">FIRST Choice item ($0 acquisition cost)</span></label>
      </div>
