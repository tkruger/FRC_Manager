    ...
    return (
      <div className="flex flex-col">
        ...
        <textarea
          ...
          id={fieldId}
          className={cn(
            "flex w-full rounded-md border bg-[--color-surface] px-3 py-2 text-sm text-[--color-text-primary]",
            "placeholder:text-[--color-text-disabled] transition-colors resize-none",
